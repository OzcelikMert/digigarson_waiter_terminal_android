...
public class RequestNotification {
    public RequestNotification(Context context){ this.context = context; }

    private String getTag() {return "Notifications RequestNotification"; }
    ...
    // Show New Order
    public void showNewRequest(NotificationInfos notificationInfos){
        int Notification_Id = Values.getNotificationIdRequest() + 1;
        try {
            /* Set Notification */
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                String OldChannelId = String.valueOf(Values.getNotificationIdRequest());
            ...
            mNotificationManager.cancel(Values.getNotificationIdRequest());
            // end Clear Notification Manager
            mNotificationManager.notify(Notification_Id, builder.build());
            // end Start New Notification

            Values.setNotificationIdRequest(Notification_Id);
